/* PowerPrep — 4th Class Part B exam prep
...
function topbar({ showNav = true } = {}) {
  ...
  return `<header class="topbar">
    <div class="brand"><span class="logo">${ICONS.bolt}</span><span>PowerPrep<small>4th Class · Part B</small></span></div>
    <div class="spacer"></div>
    ${showNav ? `<span class="countdown-chip">${dd}</span>
...
function viewUnlock(err = '', busy = false) {
  ...
  <div class="unlock-wrap"><div class="card unlock">
    ...
    <h1>PowerPrep</h1>
    <p class="sub">Fourth Class Power Engineering · Part B<br>Every knowledge exercise, as exam-style multiple choice.</p>
    <form id="unlock-form">
...
function viewHome() {
  ...
  <section class="card hero">
    ...
    <div class="hero-body">
      ...
      <p class="muted">Master all ${total} knowledge-exercise questions before June 24. Miss one and it comes back until you beat it ${CONFIG.masteryStreak} times in a row.</p>
...
function viewSettings() {
  ...
  <p class="center small muted mt">PowerPrep v4 · ${S.bank ? S.bank.length : 0} questions · built for David's June 24 exam</p>`;
}
